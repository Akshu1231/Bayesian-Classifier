...
## MAIN FILES : main.py , foo.png

## TEST & TRAINING DATA : class1.txt , class1.txt , class1.txt for each type of DataSet


## 					** The program is used to test bayes classifier for different datasets **

#-------------------------------------------------------------------------------------------------------
#				   FOR MORE DETAILS ABOUT IMPLEMENTATION OF CODE, A README FILE IS PROVIDED
#-------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------
	...
	#Precision : Positive(correct) predicted value
...
#------------------------------------------------------------------------------------------------------------
	...
	plt.savefig('rd6d.png',bbox_inches="tight", pad_inches=0)
